    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destination', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='arrivals', to='frontend.place')),
                ('origin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='departures', to='frontend.place')),
                ('depart_day', models.ManyToManyField(related_name='flights_of_the_day', to='frontend.week')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='frontend_users', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='frontend_users_permissions', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flight', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tickets', to='frontend.flight')),
                ('passengers', models.ManyToManyField(related_name='flight_tickets', to='frontend.passenger')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bookings', to='frontend.user')),
            ],
        ),
    ]
